<x-app-layout>
                            ...
                            <div>
                                <div class="mb-4 flex items-center gap-2">
                                    ...
                                    <h2 class="text-xl font-bold text-gray-900">Selected Items (<span
                                            id="item-count">0</span>)</h2>
                                </div>
                                <div id="selected-items" class="space-y-4">
                                    <div class="py-8 text-center text-gray-500" id="empty-state">
                                        <svg class="mx-auto mb-3 h-12 w-12" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 5M7 13l2.5 5M17 13v6a2 2 0 01-2 2H9a2 2 0 01-2-2v-6.1">
                                            </path>
                        ...
                        <div class="mb-6 space-y-4">
                            ...
                            <div class="border-t border-gray-200 pt-4">
                                <div class="flex justify-between text-xl font-bold">
                                    ...
                                    <span class="text-green-600" id="summary-total">Rp 0</span>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        customerSearch.value = 'Select Customer'; // Set default value
